...
public class Practica4 {
    public void Practica4()
    {
        ...
        resultado = num1*num2; // la multiplicacion para saber el resultado final
        ...
        num = Integer.parseInt(numC); // Meto el primer caracter del string a una variable llamada num
